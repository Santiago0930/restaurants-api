...
public class JwtServiceImpl implements JwtService {
    ...
    /**
     * Construye el token JWT con claims, expiración y firma digital.
     */
    ...
    /**
     * Parsea el token JWT y extrae sus claims usando la clave secreta.
     */
    ...
    /**
     * Genera la clave secreta usada para firmar y validar tokens JWT.
     */

    private SecretKey getSigningKey() {
        byte[] keyBytes = Decoders.BASE64URL.decode(jwtPrivateKey);
